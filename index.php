...
<div class="container">
	...
	<article>	
		<?php
			...
			if ($login_session==$poster_name){ 
				echo  '<h1>'.$row["title"] .'<span class="red"><a href="include/delete.php?post_id='.$row['post_id'].'">Delate POST</a></span> <span><a href="post.php?post_id='.$row['post_id'].'">Edit POST</a></span></h1>';
				}else{
				echo  '<h1>'.$row["title"] .'<span onClick="divFunction()" class="red"><a href="#">Delate POST</a></span> <span onClick="divFunction()" ><a href="#">Edit POST</a></span></h1>';
